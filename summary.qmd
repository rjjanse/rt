...
|-----------------|-------------------------------------------------------------------------------------------|------------------------------------------------------|
| R Graph Gallery | Making plots with `{base}` and `{ggplot2}`                                                | https://r-graph-gallery.com/                         |
| The R Inferno   | 'If you are using R and you think you're in hell, this is a map for you.' - Patrick Burns | https://www.burns-stat.com/pages/Tutor/R_inferno.pdf |
